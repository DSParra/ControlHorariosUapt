...
public class VentanaHorarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(JCGrupo, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jCPeriodo, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addComponent(jCDia, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jCLicenciaturaFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2021A", "2021B" }));
        jCLicenciaturaFiltro.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jCLicenciaturaFiltroItemStateChanged(evt);
            }
        });
        jCLicenciaturaFiltro.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jCLicenciaturaFiltroKeyPressed(evt);
            }
        });

        jLabel19.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(254, 254, 254));
        jLabel19.setText("LICENCIATURA");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jCGrupofiltro, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jLabel16)
                        .addGap(278, 278, 278))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jCLicenciaturaFiltro, javax.swing.GroupLayout.PREFERRED_SIZE, 325, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jCPeriodoFiltro, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(161, 161, 161))))
        );
    ...
    private void jCLicenciaturaFiltroKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jCLicenciaturaFiltroKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_jCLicenciaturaFiltroKeyPressed
    ...
    private void llenaGrupos() {
        ...
        {
            if (((Grupo) grupos.get(i)).getId_licenciatura().equals(buscaLic(null, jCLicenciatura.getSelectedItem().toString())))
            {
        ...
        if (JCGrupo.getItemCount() == 0)
        {
            Mensaje.error(this, "NO HAY GRUPOS EN LA LIC. " + jCLicenciatura.getSelectedItem().toString() + ", POR FAVOR DE ALTA UNO O VARIOS GRUPOS PARA CONTINUAR");
        }
    }
    ...
    private void llenaGruposFiltro() {
        ...
        for (int i = 0; i < grupos.size(); i++)
        {
            if (((Grupo) grupos.get(i)).getId_licenciatura().equals(buscaLic(null, jCLicenciaturaFiltro.getSelectedItem().toString())))
            {
    ...
    private void llenaMaterias() {
        ...
        {
            if (((Materia) materias.get(i)).getClaveCarrera().equals(buscaLic(null, jCLicenciatura.getSelectedItem().toString())))
            {
