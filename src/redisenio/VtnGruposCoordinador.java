 ...
 */
public class VtnGruposCoordinador extends javax.swing.JFrame {
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        {
            Grupo grup = new Grupo(txtId.getText(), txtNombre.getText(), login.lic);
     ...
     private void actualizarTabla(int valor) {
        ...
        if (valor == 1)
        {
            ...
            } else
            {
                ...
                {
                    Grupo grupo = (Grupo) g;
                    if (grupo.getId_licenciatura().equals(login.lic))
                    {
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(VtnGruposCoordinador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
